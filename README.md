...
english db file for [ZSaberLv0/ZFVimIM](https://github.com/ZSaberLv0/ZFVimIM)
...
* cloud input
    ...
    ```
    let g:ZFVimIM_english_gitUserEmail='YourEmail'
    let g:ZFVimIM_english_gitUserName='YourUserName'
    let g:ZFVimIM_english_gitUserToken='YourGithubAccessToken'
    ```
